...
#ifndef ECCLESIA_MAGENT_LIB_SMBIOS_PLATFORM_TRANSLATOR_H_
#define ECCLESIA_MAGENT_LIB_SMBIOS_PLATFORM_TRANSLATOR_H_
...
#endif  // ECCLESIA_MAGENT_LIB_SMBIOS_PLATFORM_TRANSLATOR_H_
