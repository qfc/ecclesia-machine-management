...
#ifndef ECCLESIA_MAGENT_LIB_SMBIOS_PROCESSOR_INFORMATION_H_
#define ECCLESIA_MAGENT_LIB_SMBIOS_PROCESSOR_INFORMATION_H_
...
#endif  // ECCLESIA_MAGENT_LIB_SMBIOS_PROCESSOR_INFORMATION_H_
