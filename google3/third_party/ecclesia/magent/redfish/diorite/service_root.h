...
#ifndef ECCLESIA_MAGENT_REDFISH_DIORITE_SERVICE_ROOT_H_
#define ECCLESIA_MAGENT_REDFISH_DIORITE_SERVICE_ROOT_H_
...
class ServiceRoot : public Resource {
 ...
 private:
  void Get(ServerRequestInterface *req, const ParamsType &params) override {
    Json::Value json;
    json[kOdataType] = "#ServiceRoot.v1_6_0.ServiceRoot";
...
#endif  // ECCLESIA_MAGENT_REDFISH_DIORITE_SERVICE_ROOT_H_
