...
#ifndef ECCLESIA_MAGENT_REDFISH_INTERLAKEN_PROCESSOR_METRICS_H_
#define ECCLESIA_MAGENT_REDFISH_INTERLAKEN_PROCESSOR_METRICS_H_
...
class ProcessorMetrics : public IndexResource {
 public:
...
#endif  // ECCLESIA_MAGENT_REDFISH_INTERLAKEN_PROCESSOR_METRICS_H_
