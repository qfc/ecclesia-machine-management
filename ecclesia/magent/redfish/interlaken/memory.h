...
#ifndef ECCLESIA_MAGENT_REDFISH_INTERLAKEN_MEMORY_H_
#define ECCLESIA_MAGENT_REDFISH_INTERLAKEN_MEMORY_H_
...
class Memory : public IndexResource {
 public:
...
#endif  // ECCLESIA_MAGENT_REDFISH_INTERLAKEN_MEMORY_H_
