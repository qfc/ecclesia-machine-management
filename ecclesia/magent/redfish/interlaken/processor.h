...
#ifndef ECCLESIA_MAGENT_REDFISH_INTERLAKEN_PROCESSOR_H_
#define ECCLESIA_MAGENT_REDFISH_INTERLAKEN_PROCESSOR_H_
...
#endif  // ECCLESIA_MAGENT_REDFISH_INTERLAKEN_PROCESSOR_H_
