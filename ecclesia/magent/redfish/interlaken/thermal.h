...
#ifndef ECCLESIA_MAGENT_REDFISH_INTERLAKEN_THERMAL_H_
#define ECCLESIA_MAGENT_REDFISH_INTERLAKEN_THERMAL_H_
...
#endif  // ECCLESIA_MAGENT_REDFISH_INTERLAKEN_THERMAL_H_
