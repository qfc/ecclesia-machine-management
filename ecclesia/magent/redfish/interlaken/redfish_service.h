...
#ifndef ECCLESIA_MAGENT_REDFISH_INTERLAKEN_REDFISH_SERVICE_H_
#define ECCLESIA_MAGENT_REDFISH_INTERLAKEN_REDFISH_SERVICE_H_
...
#include "ecclesia/magent/redfish/interlaken/firmware_inventory.h"
#include "ecclesia/magent/redfish/interlaken/memory.h"
#include "ecclesia/magent/redfish/interlaken/memory_collection.h"
#include "ecclesia/magent/redfish/interlaken/memory_metrics.h"
#include "ecclesia/magent/redfish/interlaken/processor.h"
#include "ecclesia/magent/redfish/interlaken/processor_collection.h"
#include "ecclesia/magent/redfish/interlaken/processor_metrics.h"
#include "ecclesia/magent/redfish/interlaken/root.h"
#include "ecclesia/magent/redfish/interlaken/service_root.h"
#include "ecclesia/magent/redfish/interlaken/software.h"
#include "ecclesia/magent/redfish/interlaken/software_inventory.h"
#include "ecclesia/magent/redfish/interlaken/system.h"
#include "ecclesia/magent/redfish/interlaken/systems.h"
#include "ecclesia/magent/redfish/interlaken/thermal.h"
#include "ecclesia/magent/redfish/interlaken/update_service.h"
...
class InterlakenRedfishService {
 public:
  explicit InterlakenRedfishService(HTTPServerInterface *server,
  ...
  InterlakenRedfishService(const InterlakenRedfishService &) = delete;
  InterlakenRedfishService &operator=(const InterlakenRedfishService &) =
      delete;
...
#endif  // ECCLESIA_MAGENT_REDFISH_INTERLAKEN_REDFISH_SERVICE_H_
