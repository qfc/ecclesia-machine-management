...
#ifndef ECCLESIA_MAGENT_LIB_EVENT_LOGGER_INTERLAKEN_SYSTEM_EVENT_VISITORS_H_
#define ECCLESIA_MAGENT_LIB_EVENT_LOGGER_INTERLAKEN_SYSTEM_EVENT_VISITORS_H_
...
// errors on an Interlaken platform

namespace ecclesia {

// Factory functions to create error counting visitors for Interlaken platform
...
#endif  // ECCLESIA_MAGENT_LIB_EVENT_LOGGER_INTERLAKEN_SYSTEM_EVENT_VISITORS_H_
