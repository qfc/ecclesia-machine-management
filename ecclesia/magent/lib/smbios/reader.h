...
#ifndef ECCLESIA_MAGENT_LIB_SMBIOS_READER_H_
#define ECCLESIA_MAGENT_LIB_SMBIOS_READER_H_

#include <memory>
#include <string>
#include <vector>

#include "magent/lib/smbios/bios.h"
...
#endif  // ECCLESIA_MAGENT_LIB_SMBIOS_READER_H_
