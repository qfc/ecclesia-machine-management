...
#ifndef ECCLESIA_MAGENT_LIB_SMBIOS_SYSTEM_EVENT_LOG_H_
#define ECCLESIA_MAGENT_LIB_SMBIOS_SYSTEM_EVENT_LOG_H_
...
#endif  // ECCLESIA_MAGENT_LIB_SMBIOS_SYSTEM_EVENT_LOG_H_
