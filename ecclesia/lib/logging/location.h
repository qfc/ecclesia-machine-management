...
// calling code. Intended only for use in the logging library, not in general.
//
...
#ifndef ECCLESIA_LIB_LOGGING_LOCATION_H_
#define ECCLESIA_LIB_LOGGING_LOCATION_H_
...
class SourceLocation {
 private:
  ...
  // with explict arguments by making it impossible to construct the first one.
  struct PrivateTag {
   private:
...
#endif  // ECCLESIA_LIB_LOGGING_LOCATION_H_
