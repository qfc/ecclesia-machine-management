...
constexpr absl::string_view kTestDataDir = "lib/smbios/test_data/";

class SmbiosReaderTest : public ::testing::Test {
 protected:
  SmbiosReaderTest() {
    std::string entry_point_path = GetTestDataDependencyPath(
        absl::StrCat(kTestDataDir, "smbios_entry_point"));
    std::string table_path =
        GetTestDataDependencyPath(absl::StrCat(kTestDataDir, "DMI"));
